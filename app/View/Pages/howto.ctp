...
<section class="row">
	<div class="medium-12 columns">
		...
		<p>You can view most of the pages without being logged in. Lists of matches (e.g. <a href="/matches/7">Uruguay vs Costa Rica</a>), teams (<a href="/teams/23">Iran</a>), goals and venues (<a href="/venues/9">Cuiabá</a>) can be found at the bottom of each page, along with the help pages. You can also see the current standings in the main league or any user leagues.</p>
		...
		<p>From your own home page (top-left option) you can do the following tasks:
			<ul>
				...
				<li>Submit a new league for creation.</li>
				<li>Change your password or time zone.</li>
			</ul>
		</p>
		<p>Clicking on another player, in a league or prediction table, will show you their predictions. For the knockout stages you will only be able to others' predictions after the deadline for that match.</p>
		...
		<p>To join a league, click on the league's page (you can see all user leagues <a href="/leagues">here</a>). User leagues may be public or private. Public leagues can be joined freely, for private leagues you can request to join and that request will be forwarded to the league organiser for a decision.</p>
		<p>You may request to create your own user league. From your home page, click the '<a href="/leagues/add">create a new user league</a>' link and fill out the form. If your request is accepted then a new user league will be created with you as the organiser.</p>
